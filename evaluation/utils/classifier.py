...
def load_pkl(file_or_url):
    ...
    # else:
    file = open('classifiers/' + file_or_url, 'rb')
...
classifier_urls = [
    ...
    'https://drive.google.com/uc?id=1RgASVHW8EWMyOCiRb5fsUijFu-HfxONM',
...
def make_classifier(attrib_idx):
    str_att = '{:02d}'.format(attrib_idx)
    print('celebahq-classifier-' + str_att + '-' + classifier_id_name[attrib_idx] + '.pkl')
    classifier = load_pkl('celebahq-classifier-' + str_att + '-' + classifier_id_name[attrib_idx] + '.pkl')
    return classifier
