...
This repository contains  supplementary materials and  the official PyTorch implementation of the paper:
 **_IA-FaceS: A Bidirectional Method for Semantic Face Editing_**
...
#### The code of PyTorch implementation will be released later.
